document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        error = getFieldLabel(field, form) + ' is required.';
      } else if (value !== '') {
        if (type === 'email' && !isValidEmail(value)) {
          ...
          if (value.length < min) {
            error = getFieldLabel(field, form) + ' must be at least ' + min + ' characters.';
          }
        } else if (field.hasAttribute('maxlength')) {
          const max = parseInt(field.getAttribute('maxlength'), 10);
          if (value.length > max) {
            error = getFieldLabel(field, form) + ' must be no more than ' + max + ' characters.';
          }
        }
      }
  ...
  function handleFormSuccess(form) {
    ...
    successEl.textContent = form.dataset.successMessage || 'Thank you! Your message has been sent successfully.';
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '768125bb-c4d1-4154-900e-15f10ab61fbe',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '768125bb-c4d1-4154-900e-15f10ab61fbe';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '768125bb-c4d1-4154-900e-15f10ab61fbe';
